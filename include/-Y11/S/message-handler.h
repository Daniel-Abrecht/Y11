...
#define C(PARAM, NAME, VALUE) \
  void y11_msg_cb_ ## NAME(struct y11_s_client*const client, uint16_t response_id, y11_msg_ ## NAME ## _t* msg, unsigned payload_size, char payload[restrict payload_size]);
